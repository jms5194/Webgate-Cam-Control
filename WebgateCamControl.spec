...
datas = [
    ('.env', '.'),
    ('resources/webgate.icns', './resources'),
    ('resources/webgate.ico', './resources'),
]
...
if args.win:
    exe = EXE(
        ...
        a.datas,
        a.scripts,
        name='Webgate Camera Control',
        icon='resources/webgate.ico',
    ...
    app = BUNDLE(
        exe,
        name='Webgate Camera Control.app',
        icon='resources/webgate.icns',
        bundle_identifier='com.justinstasiw.webgatecamcontrol',
        version='1.0.0',
        info_plist={
